...
linq4android is a project to provide Linq Query facility to android developers. It is heavily from <a href="https://code.google.com/p/diting/">diting</a>. The library provides optimized queries on collections and arrays. It is acctually the port of traditional chainable queries to android plateform in order to provide query capabilities on collections or array through chainable methods and anonymous interface like .Net's Linq. Currently the library provides the following methods.
...
svn checkout https://github.com/ziaagikian/linq4qndroid linq4android-read-only 
...
<a href="https://github.com/ziaagikian/linq4android/binary/linq4qndroid-1.0.jar">download jar</a>
...
h3. Try library and implement queries as per your requirement, in case of any ambiguity just post your questions on Github, by creating issues on Github.
